...
const coffee = (
    <svg className={styles.coffeeIcon} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 92.1 100">
...
export default ({friend, recordCoffee}) => (
    <div className={styles.friend}>
        ...
        <div className={styles.action}><button className={styles.button} onClick={() => recordCoffee(friend)}>{coffee}</button></div>
    </div>
)
